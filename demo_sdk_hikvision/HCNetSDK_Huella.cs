...
namespace demo_sdk_hikvision
{
    class HCNetSDK_Huella
    {
        ...
        public struct NET_DVR_FINGERPRINT_COND
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Huella.ACS_CARD_NO_LEN)]
            ...
            public void init()
            {
                byCardNo = new byte[HCNetSDK_Huella.ACS_CARD_NO_LEN];
                byRes = new byte[131];
            }
        }
        ...
        public struct NET_DVR_FINGERPRINT_RECORD
        {
            ...
            public byte[] byRes1;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Huella.MAX_FINGER_PRINT_LEN)]
            ...
            public void init()
            {
                byCardNo = new byte[HCNetSDK_Huella.ACS_CARD_NO_LEN];
                byRes1 = new byte[30];
                byFingerData = new byte[HCNetSDK_Huella.MAX_FINGER_PRINT_LEN];
                byRes = new byte[96];
            }
        }
        ...
        public struct NET_DVR_FINGER_PRINT_INFO_CTRL_V50_ByCardNo
        {
            ...
            public byte[] byRes1;
            public HCNetSDK_Huella.NET_DVR_FINGER_PRINT_BYCARD_V50 struProcessMode;//处理方式
        ...
        public struct NET_DVR_FINGER_PRINT_INFO_CTRL_V50_ByCardReader
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] byRes1;
            public HCNetSDK_Huella.NET_DVR_FINGER_PRINT_BYREADER_V50 struProcessMode;//处理方式
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64)]
            public byte[] byRes;
        }
        ...
        public struct NET_DVR_FINGER_PRINT_BYCARD_V50
        {
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Huella.ACS_CARD_NO_LEN)]
            public byte[] byCardNo;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Huella.MAX_CARD_READER_NUM_512)]
            public byte[] byEnableCardReader;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Huella.MAX_FINGER_PRINT_NUM)]
            public byte[] byFingerPrintID;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2)]
            public byte[] byRes1;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Huella.NET_SDK_EMPLOYEE_NO_LEN)]
            public byte[] byEmployeeNo;
            public void init()
            {
                byCardNo = new byte[HCNetSDK_Huella.ACS_CARD_NO_LEN];
                byEnableCardReader = new byte[HCNetSDK_Huella.MAX_CARD_READER_NUM_512];
                byFingerPrintID = new byte[HCNetSDK_Huella.MAX_FINGER_PRINT_NUM];
                byRes1 = new byte[2];
                byEmployeeNo = new byte[HCNetSDK_Huella.NET_SDK_EMPLOYEE_NO_LEN];
            }
        }
        ...
        public struct NET_DVR_FINGERPRINT_STATUS
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Huella.ERROR_MSG_LEN)]
            ...
            {
                byCardNo = new byte[HCNetSDK_Huella.ACS_CARD_NO_LEN];
                byErrorMsg = new byte[HCNetSDK_Huella.ERROR_MSG_LEN];
        ...
        [DllImport(@"HCNetSDK\HCNetSDK.dll")]
        public static extern int NET_DVR_GetNextRemoteConfig(int lHandle, ref HCNetSDK_Huella.NET_DVR_FINGERPRINT_RECORD lpOutBuff, int dwOutBuffSize);

        [DllImport(@"HCNetSDK\HCNetSDK.dll")]
        public static extern int NET_DVR_StopRemoteConfig(int lHandle);

        [DllImport(@"HCNetSDK\HCNetSDK.dll")]
        public static extern int NET_DVR_GetNextRemoteConfig(int lHandle, ref HCNetSDK_Huella.NET_DVR_FINGER_PRINT_INFO_STATUS_V50 lpOutBuff, int dwOutBuffSize);

        [DllImport(@"HCNetSDK\HCNetSDK.dll")]
        public static extern int NET_DVR_SendWithRecvRemoteConfig(int lHandle, ref HCNetSDK_Huella.NET_DVR_FINGERPRINT_RECORD lpInBuff, int dwInBuffSize, ref HCNetSDK_Huella.NET_DVR_FINGERPRINT_STATUS lpOutBuff, int dwOutBuffSize, IntPtr dwOutDataLen);

        [DllImport(@"HCNetSDK\HCNetSDK.dll")]
        public static extern bool NET_DVR_SetLogToFile(int nLogLevel, string strLogDir, bool bAutoDel);

        [DllImport(@"HCNetSDK\HCNetSDK.dll")]
        public static extern int NET_DVR_GetNextRemoteConfig(int lHandle, ref HCNetSDK_Huella.NET_DVR_CAPTURE_FINGERPRINT_CFG lpOutBuff, int dwOutBuffSize);
        #endregion
