...
namespace demo_sdk_hikvision
{
    public class HCNetSDK_Tarjeta
    {
        ...
        public struct NET_DVR_CARD_CFG_V50
        {
            ...
            public void Init()
            {
                byDoorRight = new byte[HCNetSDK_Tarjeta.MAX_DOOR_NUM_256];
                byBelongGroup = new byte[HCNetSDK_Tarjeta.MAX_GROUP_NUM_128];
                wCardRightPlan = new ushort[HCNetSDK_Tarjeta.MAX_DOOR_NUM_256 * HCNetSDK_Tarjeta.MAX_CARD_RIGHT_PLAN_NUM];
                byCardNo = new byte[HCNetSDK_Tarjeta.ACS_CARD_NO_LEN];
                byCardPassword = new byte[HCNetSDK_Tarjeta.CARD_PASSWORD_LEN];
                byName = new byte[HCNetSDK_Tarjeta.NAME_LEN];
                byRes2 = new byte[3];
                byLockCode = new byte[HCNetSDK_Tarjeta.MAX_LOCK_CODE_LEN];
                byRoomCode = new byte[HCNetSDK_Tarjeta.MAX_DOOR_CODE_LEN];
                byRes3 = new byte[83];
            }
        }
        ...
        {
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Tarjeta.ACS_CARD_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Tarjeta.MAX_CARD_READER_NUM_512, ArraySubType = UnmanagedType.I1)]
            public byte[] byEnableCardReader;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Tarjeta.MAX_FACE_NUM, ArraySubType = UnmanagedType.I1)]
            ...
            {
                byCardNo = new byte[HCNetSDK_Tarjeta.ACS_CARD_NO_LEN];
                byEnableCardReader = new byte[HCNetSDK_Tarjeta.MAX_CARD_READER_NUM_512];
                byFaceID = new byte[HCNetSDK_Tarjeta.MAX_FACE_NUM];
                byRes1 = new byte[42];
            }
        }
        ...
        public struct NET_DVR_ACS_EVENT_COND
        {
            ...
            public uint dwMajor;
            public uint dwMinor;
            public HCNetSDK_Tarjeta.NET_DVR_TIME struStartTime;
            public HCNetSDK_Tarjeta.NET_DVR_TIME struEndTime;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Tarjeta.ACS_CARD_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Tarjeta.NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byName;
            ...
            public byte byRes1;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = HCNetSDK_Tarjeta.NET_SDK_MONITOR_ID_LEN)]
            public string szMonitorID;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Tarjeta.NET_SDK_EMPLOYEE_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byEmployeeNo;
            ...
            public void Init()
            {
                ...
                byName = new byte[HCNetSDK_Tarjeta.NAME_LEN];
                byRes2 = new byte[2];
                byEmployeeNo = new byte[HCNetSDK_Tarjeta.NET_SDK_EMPLOYEE_NO_LEN];
                byRes = new byte[140];
            }
        }
        ...
        public struct NET_DVR_ACS_EVENT_CFG
        {
            ...
            public uint dwMajor;
            public uint dwMinor;
            public HCNetSDK_Tarjeta.NET_DVR_TIME struTime;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Tarjeta.MAX_NAMELEN)]
            public byte[] sNetUser;
            public HCNetSDK_Tarjeta.NET_DVR_IPADDR struRemoteHostAddr;
            public HCNetSDK_Tarjeta.NET_DVR_ACS_EVENT_DETAIL struAcsEventInfo;
        ...
        {
            public uint dwSize;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Tarjeta.ACS_CARD_NO_LEN)]
            public byte[] byCardNo;
            ...
            public byte byType;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Tarjeta.MACADDR_LEN)]
            public byte[] byMACAddr;
            ...
            public byte[] byRe2;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Tarjeta.NET_SDK_EMPLOYEE_NO_LEN)]
            public byte[] byEmployeeNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 64)]
            public byte[] byRes;
        }
        ...
        [DllImport(@"HCNetSDK\HCNetSDK.dll")]
        public static extern bool NET_DVR_Logout(Int32 lUserID);//Establecida por LERA
        ...
        [DllImport(@"HCNetSDK\HCNetSDK.dll")]
        public static extern bool NET_DVR_CaptureJPEGPicture(int lUserID, int lChannel, ref HCNetSDK_Tarjeta.NET_DVR_JPEGPARA lpJpegPara, IntPtr sPicFileName);
        #endregion
