...
{
    public class HCNetSDK_EventoACS
    {
        ...
        [DllImport(@"HCNetSDK\HCNetSDK.dll")]
        public static extern int NET_DVR_GetNextRemoteConfig(int lHandle, ref HCNetSDK_EventoACS.NET_DVR_ACS_EVENT_CFG lpOutBuff, int dwOutBuffSize);
        ...
        public struct NET_DVR_ACS_EVENT_COND
        {
            ...
            public uint dwMajor;
            public uint dwMinor;
            public HCNetSDK_EventoACS.NET_DVR_TIME struStartTime;
            public HCNetSDK_EventoACS.NET_DVR_TIME struEndTime;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_EventoACS.ACS_CARD_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_EventoACS.NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byName;
            ...
            public byte byRes1;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = HCNetSDK_EventoACS.NET_SDK_MONITOR_ID_LEN)]
            public string szMonitorID;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_EventoACS.NET_SDK_EMPLOYEE_NO_LEN, ArraySubType = UnmanagedType.I1)]
            ...
            public void Init()
            {
                byCardNo = new byte[HCNetSDK_EventoACS.ACS_CARD_NO_LEN];
                byName = new byte[HCNetSDK_EventoACS.NAME_LEN];
                byRes2 = new byte[2];
                byEmployeeNo = new byte[HCNetSDK_EventoACS.NET_SDK_EMPLOYEE_NO_LEN];
                byRes = new byte[140];
            }
        }
        ...
        {
            public uint dwSize;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_EventoACS.ACS_CARD_NO_LEN)]
            public byte[] byCardNo;
            ...
            public byte byType;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_EventoACS.MACADDR_LEN)]
            ...
            public byte[] byRe2;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_EventoACS.NET_SDK_EMPLOYEE_NO_LEN)]
            public byte[] byEmployeeNo;
            ...
            {
                byCardNo = new byte[HCNetSDK_EventoACS.ACS_CARD_NO_LEN];
                byMACAddr = new byte[HCNetSDK_EventoACS.MACADDR_LEN];
                byRe2 = new byte[2];
                byEmployeeNo = new byte[HCNetSDK_EventoACS.NET_SDK_EMPLOYEE_NO_LEN];
                byRes = new byte[64];
            }
        ...
        public struct NET_DVR_ACS_EVENT_CFG
        {
            ...
            public uint dwMajor;
            public uint dwMinor;
            public HCNetSDK_EventoACS.NET_DVR_TIME struTime;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_EventoACS.MAX_NAMELEN)]
            public byte[] sNetUser;
            public HCNetSDK_EventoACS.NET_DVR_IPADDR struRemoteHostAddr;
            public HCNetSDK_EventoACS.NET_DVR_ACS_EVENT_DETAIL struAcsEventInfo;
            ...
            public void init()
            {
                sNetUser = new byte[HCNetSDK_EventoACS.MAX_NAMELEN];
